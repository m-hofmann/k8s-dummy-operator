...
type DummySpec struct {
	// simply a message string, holds informative details about this Dummy
	Message string `json:"message,omitempty"`
}

// DummyStatus defines the observed state of Dummy
type DummyStatus struct {
	// after reconciliation this field contains content of spec.message
	SpecEcho string `json:"specEcho,omitempty"`
	// reflects status of pod associated with this Dummy
